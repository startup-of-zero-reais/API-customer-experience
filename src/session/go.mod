module github.com/startup-of-zero-reais/API-customer-experience/src/session
...
require (
	...
	github.com/startup-of-zero-reais/API-customer-experience/src/common v0.0.0-20220417021424-c7eae58a6f82
