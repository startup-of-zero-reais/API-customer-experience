module github.com/startup-of-zero-reais/API-customer-experience/src/favorites
...
require (
	...
	github.com/startup-of-zero-reais/API-customer-experience/src/common v0.0.0-20220415050352-bd3112d5b965
